...
for sca in range(1, 19):
    util = roman_utils("was.yaml", image_name=f"Roman_WAS_simple_model_Y106_{id:d}_{sca:d}.fits.gz")
...
fits.HDUList(hdulist).writeto(f"psf/psf_polyfit_{id:d}.fits", overwrite=True)
