...
def gen_truthcats(pars):
    ...
    for iblock in range(nstart, nblockmax**2):
        ...
        for layerName in use_layers:
            ...
            if this_res not in resolutionTables:  # This will happen every time we start a new block
                ...
                # Initiate table
                blockTable = Table()
                blockTable["Block"] = [rf"{ibx:02d}_{iby:02d}"] * npix
            ...
            icase = f"{use_layers[layerName]:d}"
            ...
            if "gsext" in layerName:
                ...
                resolutionTables[this_res]["sersic_r_L" + icase] = truthcat["sersic"]["r"][
                    :
                ]  # this needs to be able to get the right table
